...
// import { useTermStore } from "../stores/store";

// type EntityManagerTermProps = {
//   entityName: string;
// };

// const EntityManagerTerm: React.FC<EntityManagerTermProps> = ({
//   entityName,
// }) => {
//   const {
//     entities,
...
//   const handleEditEntity = (entity: TermEntity) => {
//     setEditEntityId(entity.id);
//     setEditEntityName(entity.term);
...
//   const columns = useMemo<ColumnDef<TermEntity>[]>(
//     () => [
//       {
...
// export default EntityManagerTerm;
