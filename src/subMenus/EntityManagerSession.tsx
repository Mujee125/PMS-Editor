...
// type EntityManagerSessionProps = {
//   entityName: string;
// };

// const EntityManagerSession: React.FC<EntityManagerSessionProps> = ({
//   entityName,
// }) => {
//   const {
//     entities,
...
//   const handleEditEntity = (entity: SessionEntity) => {
//     setEditEntityId(entity.id);
//     setEditEntityName(entity.session);
...
//   const columns = useMemo<ColumnDef<SessionEntity>[]>(
//     () => [
//       {
...
// export default EntityManagerSession;
